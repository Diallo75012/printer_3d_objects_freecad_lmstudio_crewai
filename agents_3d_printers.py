...
def freecad_script_execution(path_to_script):
  ...
  """
  return os.system(f"/home/creditizens/printer_3d_llm_agents/freecad/AppRun freecadcmd {path_to_script}")
...
gcode_file_check_presence = DirectoryReadTool("/home/creditizens/printer_3d_llm_agent/sliced_layers")
